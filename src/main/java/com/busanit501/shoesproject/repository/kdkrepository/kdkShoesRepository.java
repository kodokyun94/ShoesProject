...
public interface kdkShoesRepository extends JpaRepository<ShoesMember, String> {
    ...
    // 이메일으로 유저 확인.
    @EntityGraph(attributePaths = "roleSet")
    ShoesMember findByMemberEmail(String memberEmail);

    ShoesMember findByMemberId(String memberId);
