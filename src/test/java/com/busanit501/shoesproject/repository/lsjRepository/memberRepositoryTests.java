...
public class memberRepositoryTests {
    ...
    public void testRead() {
        Optional<Member> result = MemberRepository.getWithRoles("ddd2");
        Member member = result.orElseThrow();

        log.info("shoesMemberRepositoryTests testRead, shoesMember:  "+ member);
        log.info("shoesMemberRepositoryTests testRead, shoesMember.getRoleSet():  "+ member.getRoleSet());

        member.getRoleSet().forEach(shoesMemberRole -> {
    ...
    public void testUpdate() {
        ...
        MemberRepository.updatePassword(memberId, memberPw);
    }
